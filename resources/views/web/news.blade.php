...
<div class="thumbnail post_n">
  <a href="" >
<b><h4 style="color:#bd720c;">{{ $n->title }}<img  src="https://pbs.twimg.com/media/DQiDpZuXUAA_si2.jpg"  style="width:115px; "  align="right"> </h4></b></a> 
<p style="color:gray; font-size:10px;"><i class="fa fa-calendar" aria-hidden="true" style="padding-right: 5px"></i>{{$n->created_at}}</p>
<div id="myhide">
    <p align="center">{{ $n->content }}<a href="news/{{$n->id}}" style="color:blue">أقراء المزيد...</a>
